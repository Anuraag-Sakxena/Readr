...
export const mockEdition: ScreenCard[] = [
...

  {
    ...
    payload: {
      ...
      whatHappened: "Major indices traded in a narrow range while traders positioned for upcoming reports.",
      whyItMatters: "Key releases can shift rate expectations and affect borrowing costs across the economy.",
  ...
  },
  {
    ...
    payload: {
      ...
      whatHappened: "A new set of routes will be added to improve connectivity during peak hours.",
...

  {
    ...
    payload: {
      ...
      whatHappened: "Several companies described guardrails and evaluation methods for their latest releases.",
      whyItMatters: "Better controls reduce risk and improve trust as AI adoption accelerates.",
